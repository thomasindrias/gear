  ...
  return (
    <form onSubmit={handleSubmit} className="relative">
      ...
      <input
        ...
        className="w-full bg-transparent border border-neutral-800 rounded-lg pl-11 pr-12 py-3 text-sm text-neutral-200 placeholder:text-neutral-600 focus:outline-none focus:border-neutral-600 font-mono transition"
      />
